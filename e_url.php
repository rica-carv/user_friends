...
class user_friends_url
{
		public $alias = 'user_friends';
	function config()
	{
		$config = array();
		...
		$config['index'] = array(
			...
			'redirect' => '{e_PLUGIN}user_friends/user_friends.php$1', // ficheiro real
			'legacy' => '{e_PLUGIN}user_friends/user_friends.php$1', // ficheiro real
		);
/*
