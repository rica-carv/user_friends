...
*/
/*
$e107_user_extended_struct = array(
	array(
		"user_extended_struct_id" => 6,
		"user_extended_struct_name" => "plugin_user_friends_allow",
		"user_extended_struct_text" => "Permitir Amigos",
		"user_extended_struct_type" => 10,
		"user_extended_struct_parms" => "plugin_user_friends",
		"user_extended_struct_values" => "",
		"user_extended_struct_default" => "1",
		"user_extended_struct_read" => 255,
		"user_extended_struct_write" => 255,
		"user_extended_struct_required" => 0,
		"user_extended_struct_signup" => 0,
		"user_extended_struct_applicable" => 255,
...
/*
        ...
        <!-- Mapeia para user_extended_struct_read e write (253 = User+Admin) -->
        <view>253</view> 
        <edit>253</edit> 
        
        <!-- Mapeia para user_extended_struct_signup (0 = Não mostrar no registo) -->
        <signup>0</signup>
        
        <!-- Mapeia para user_extended_struct_required -->
        <required>1</required>
        
        <!-- Valores para a checkbox (Sim,Não) -->
        <writeParms>
            <label>yesno</label>
