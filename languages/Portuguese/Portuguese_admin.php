...
define("LANAD_EUSER_21", "Redireccionar os novos utilizadores para o perfil após entrar no site?");//define("LAN_EUSER_ADMIN_307", "Redirect new users after logon to the profile set page");
...
define("LANAD_USERFRIENDS_4", "Aviso de pedido de amizade enviado por mensagem privada");//Ex LAN_EUSER_ADMIN_402
define("LANAD_USERFRIENDS_5", "Aviso de pedido de amizade enviado por email");//Ex LAN_EUSER_ADMIN_403
define("LANAD_USERFRIENDS_6", "Lista de amigos privada");
