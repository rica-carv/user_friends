...
//	if (!$this->var['euser_pref']['friend_sys']) { return null;} //Failsafe para o caso de chegar aqui e o ficheiro ser carregado....
...
//		if ($this->var['euser_pref']['friend_sys'] == "ON" || $this->var['euser_pref']['friend_sys'] == "") {
		if ($this->var['euser_pref']['friend_col'] == '') {
			$frcolumn = '6';
		} elseif ($this->var['euser_pref']['friend_col'] > '8') {
			$frcolumn = '8';
		} elseif ($this->var['euser_pref']['friend_col'] < '2') {
			$frcolumn = '2';
		} else {
			$frcolumn = $this->var['euser_pref']['friend_col'];
		}
